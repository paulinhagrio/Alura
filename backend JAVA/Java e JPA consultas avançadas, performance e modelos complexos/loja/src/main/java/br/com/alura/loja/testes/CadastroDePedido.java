...
public class CadastroDePedido {
    public static void main(String[] args) {
        ...
        relatorio.forEach(System.out::println);   //Vai percorrer cada um dos elementos e dar um System.out nele
    }
    ...
    private static void popularBancoDeDados() {
        ...
        Produto macbook = new Produto(" Macbook", "Macboo pro reti", new BigDecimal("800") , informatica );
